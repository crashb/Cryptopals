...
class Sha1Hash(object):
	...
	# modified to allow for custom values of a-e and length extension --nick
	def __init__(self, h0, h1, h2, h3, h4, byteLen):
		...
		self._message_byte_length = byteLen
...
# modified to allow for custom values of a-e and length extension --nick
def sha1(data, a=0x67452301, b=0xEFCDAB89, c=0x98BADCFE, d=0x10325476, e=0xC3D2E1F0, byteLen=0):
	...
	"""
	return Sha1Hash(a, b, c, d, e, byteLen).update(data).hexdigest()
